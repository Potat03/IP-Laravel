...
onclick="location.href='{{url('/admin/orders/prepare')}}'">
...
<button class="btn btn-primary"
onclick="location.href='{{url('/admin/orders/delivered')}}'">
...
<table class="table">
    ...
    <tbody id="data-holder">
        ...
        <tr id="row_{{ $order->order_id }}" class="animate-row" style="animation-delay: 0.05s;">
            ...
            <td style="text-align:left!important;">{{ \Carbon\Carbon::parse($order->created_at)->format('d-m-Y h:iA') }}
            </td>
            ...
            <td><button type="button" class="btn btn-primary" onclick="proceedToNext({{ $order->order_id }})">&#10143;
                    DELIVERED</button>
