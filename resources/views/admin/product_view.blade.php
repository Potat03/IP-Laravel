            ...
            <form method="POST" id="productForm" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                        value="{{ $product->name }}" required disabled>
                </div>
                <div class="mb-3">
                    <label for="price" class="form-label">Price</label>
                    <input type="number" step="0.01" class="form-control" id="price" name="price"
                        value="{{ $product->price }}" required min="0.01" disabled>
                </div>
                <div class="mb-3">
                    <label for="stock" class="form-label">Stock</label>
                    <input type="number" class="form-control" id="stock" name="stock"
                        value="{{ $product->stock }}" required min="1" disabled>
                </div>
                <div class="mb-3">
                ...
                @if ($product->wearable)
                <input type="hidden" id="isWearable" value="1" disabled>
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="expiry_date" name="expiry_date"
                            value="{{ $product->consumable->expire_date }}" required disabled>
                    </div>

                    <div class="mb-3">
                        <label for="portion" class="form-label">Portion:</label>
                        <input type="number" class="form-control" id="portion" name="portion"
                            value="{{ $product->consumable->portion }}" required min="1" disabled>
                    </div>

                    <div class="mb-3">
                        <label for="halal" class="form-label">Halal:</label>
                        <select class="form-control" id="halal" name="halal" required disabled>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="supplier" name="supplier"
                            value="{{ $product->collectible->supplier }}" required disabled>
                    </div>
                    @endif
                    ...
                    <div class="mb-3 form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="statusSwitch" name="status" value="active" disabled
