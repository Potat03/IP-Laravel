...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Seed Products
        Product::create([
            'name' => 'Demon Slayer Shirt',
            'description' => 'Demon Slayer Limited Edition Shirt',
            'price' => '60',
            'stock' => '100',
            'status' => 'active',
        ]);
        ...
        Product::create([
            'name' => 'Pokemon Lucky Bag',
            'description' => 'Comes with limited edition pokemon plush',
            'price' => '70',
            'stock' => '45',
            'status' => 'active',
        ]);
        ...
        Product::create([
            'name' => '10 in 1 Snack Pack',
            'description' => 'All 10 different snacks for you to try out',
            'price' => '100',
            'stock' => '50',
            'status' => 'active',
        ]);
